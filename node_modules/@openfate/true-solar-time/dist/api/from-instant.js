...
exports.getTrueSolarTimeFromInstant = getTrueSolarTimeFromInstant;
 ...
 */
function getOffsetsAtInstant(date, timeZoneId) {
    var _a, _b;
    ...
    const offsetStr = (_b = (_a = parts.find(p => p.type === 'timeZoneName')) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : 'GMT+00:00';
    ...
    const getYearOffset = (d, month0) => {
        ...
        const probeStr = (_b = (_a = probeParts.find(p => p.type === 'timeZoneName')) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : 'GMT+00:00';
 ...
 */
function getWallClockAtInstant(date, timeZoneId) {
    const parts = new Intl.DateTimeFormat('en-US', {
        timeZone: timeZoneId,
 ...
 */
function getTrueSolarTimeFromInstant(input, options) {
